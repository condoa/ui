<template>
    <ContextMenuItem data-slot="context-menu-item" v-bind="forwarded" :data-inset="inset" :data-variant="variant" :class="styles({ inset, class: props.class, variant })">
        <slot>
...
const forwarded = useForwardPropsEmits(reactiveOmit(props, 'class', 'inset', 'shortcut', 'title'), emits)
