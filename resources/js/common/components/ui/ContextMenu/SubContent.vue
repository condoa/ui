<template>
    <ContextMenuPortal>
        <ContextMenuSubContent data-slot="context-menu-sub-content" v-bind="{ ...forwarded, ...$attrs }" :class="styles({ class: props.class })">
            <slot />
