...
interface Props {
    /** Additional classes to add to the group wrapper */
    class?: ClassValue
}
...
const styles = tv({
    base: [
        'relative inline-flex w-full min-w-0 items-center overflow-hidden rounded-md border border-input bg-background not-dark:bg-clip-padding text-base text-foreground shadow-xs/5 ring-ring/24 transition-shadow',
        ...
        'sm:text-sm',
        'dark:bg-input/32 dark:has-autofill:bg-foreground/8',
