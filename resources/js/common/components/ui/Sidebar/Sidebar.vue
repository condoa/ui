...
import { type ClassValue, tv, type VariantProps } from 'tailwind-variants'
  ...
  export const sideBarStyles = tv({
    slots: {
      ...
      sideBarWrapper:
        "relative w-(--sidebar-width) bg-transparent transition-[width] duration-200 ease-linear motion-reduce:transition-none group-data-[collapsible=offcanvas]:w-0 group-data-[side=right]:rotate-180",
      sideBarWrapper2:
