<template>
    <div class="w-full">
        ...
        <div class="relative">
            ...
            <NativeSelect :id="inputId" v-model="value" :required="required" :trailing-icon="trailingIcon" :aria-invalid="!!errorMessage" :aria-describedby="errorMessage ? errorId : undefined" :name="name" v-bind="$attrs" :class="[hasIcon && 'pl-9']" @blur="handleBlur">
                <slot />
            </NativeSelect>
        </div>
