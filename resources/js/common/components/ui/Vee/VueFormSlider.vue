<template>
    <div class="w-full">
        ...
        <TransitionSlide group tag="div">
            ...
            <p v-if="errorMessage" :id="errorId" role="alert" key="errorMessage" class="mt-1.5 text-sm text-destructive">
                {{ errorMessage }}
            </p>
        </TransitionSlide>
    </div>
...
const props = withDefaults(defineProps<SliderProps>(), { showTooltip: "drag" })
